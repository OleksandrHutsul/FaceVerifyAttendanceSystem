...
namespace FaceVerifyAttendanceSystem.UI.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        [BindProperty]
        public EnableAuthenticatorDTO EnableAuthenticatorDTO { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var verificationCode = EnableAuthenticatorDTO.Code.Replace(" ", string.Empty).Replace("-", string.Empty);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Face Verify Attendance System"),
